        ...
        <div class="container">
            <div class="footer-top-at">
                ...
                <h4>CONTACT US</h4>
                    ...
                    <?php 
                        Modal::begin([
                            'header' => '<h2>Форма обратной связи</h2>',
                            'toggleButton' => [
                                'label' => 'Напишите нам',
                                'class' => 'hvr-rectangle-out',
                            ],
                            'footer' => 'форма разработата в <a title="перейти на сайт студии WEBMASTER STUDIO" target="_blank" href="http://webmaster-studio.ru/">Webmaster Studio</a>',
                        ]);
                    ?>
